        ...
        class _Handler(BaseHTTPRequestHandler):
            ...
            def do_GET(inner_self):
                ...
                if path == "/" or path == "/index.html":
                    # The dashboard SPA is the only index now — the embedded
                    # fallback page was removed with the mobile-UI deprecation.
                    ...
                    try:
                        ...
                        # A missing/unreadable dashboard means a broken install.
                        inner_self._send_json({"error": "page not found"}, 500)
                    return
