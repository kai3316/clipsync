...
_EN: dict[str, str] = {
    ...
    "settings_window.netpair_password_label": "Pairing passphrase",
    "settings_window.netpair_password_unset": "Not set",
    "settings_window.netpair_password_set": "Set 🔒",
    "settings_window.netpair_password_btn_set": "Set",
    "settings_window.netpair_password_btn_modify": "Change",
    "settings_window.netpair_password_btn_clear": "Clear",
    "settings_window.netpair_password_placeholder": "Enter a pairing passphrase",
    "settings_window.netpair_password_confirm_placeholder": "Re-enter to confirm",
    "settings_window.netpair_password_rule_length": "At least 12 characters",
    "settings_window.netpair_password_rule_upper": "Uppercase letter",
    "settings_window.netpair_password_rule_lower": "Lowercase letter",
    "settings_window.netpair_password_rule_digit": "Number",
    "settings_window.netpair_password_rule_special": "Special character",
    "settings_window.netpair_password_hint": "When set, only devices using the same passphrase can pair and communicate; devices without it cannot. Leave empty for the default behavior.",
    "settings_window.netpair_password_saved": "Pairing passphrase saved",
    "settings_window.netpair_password_cleared": "Pairing passphrase cleared",
    "settings_window.netpair_password_mismatch": "Passphrases do not match",
    "settings_window.netpair_password_clear_confirm_title": "Clear pairing passphrase?",
    "settings_window.netpair_password_clear_confirm_msg": "Paired devices must set the same passphrase to keep communicating.",
...
_ZH: dict[str, str] = {
    ...
    "settings_window.netpair_password_label": "配对加密密码",
    "settings_window.netpair_password_unset": "未设置",
    "settings_window.netpair_password_set": "已设置 🔒",
    "settings_window.netpair_password_btn_set": "设置",
    "settings_window.netpair_password_btn_modify": "修改",
    "settings_window.netpair_password_btn_clear": "清除",
    "settings_window.netpair_password_placeholder": "输入配对加密密码",
    "settings_window.netpair_password_confirm_placeholder": "再次输入以确认",
    "settings_window.netpair_password_rule_length": "至少 12 个字符",
    "settings_window.netpair_password_rule_upper": "含大写字母",
    "settings_window.netpair_password_rule_lower": "含小写字母",
    "settings_window.netpair_password_rule_digit": "含数字",
    "settings_window.netpair_password_rule_special": "含特殊字符",
    "settings_window.netpair_password_hint": "开启后仅与设置了相同密码的设备配对通信；未设密码的设备将无法配对。清除后恢复默认行为。",
    "settings_window.netpair_password_saved": "配对加密密码已保存",
    "settings_window.netpair_password_cleared": "已清除配对加密密码",
    "settings_window.netpair_password_mismatch": "两次输入的密码不一致",
    "settings_window.netpair_password_clear_confirm_title": "清除配对加密密码？",
    "settings_window.netpair_password_clear_confirm_msg": "已配对的设备需要设置相同的密码才能继续通信。",
