...
_EN: dict[str, str] = {
    ...
    "ui.web_companion": "Web Companion",
    "ui.web_start_failed": "Failed to start Web Companion on port {port}.\n\nAnother process may already be using this port, or the server failed to bind.\n\nTried ports: {lo} - {hi}",
    ...
    "ui.file_not_found_msg": "File not found:\n",
    ...
    "overview.web_companion": "Web Companion",
    ...
    "carousel.web_companion": "Web Companion",
