...
_EN: dict[str, str] = {
    ...
    "settings_window.relay_password_hint": "Blank keeps the stored password. Used to authenticate to a private broker; leave empty for anonymous public brokers.",
...
_ZH: dict[str, str] = {
    ...
    "settings_window.relay_password_hint": "留空表示保留已保存的密码。用于连接私有 broker 的鉴权；公共匿名 broker 留空即可。",
