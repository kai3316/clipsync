...
_EN: dict[str, str] = {
    # Errors that reach a reader.  These are the localized spelling of the
    # ApplicationError codes in internal/application/errors.py; the code stays
    # the machine-readable half, so nothing here is parsed by a caller.
    "error.app_locked": "The app is locked. Unlock it and try again.",
    "error.not_found": "Not found.",
    "error.not_connected": "The device is not connected.",
    "error.not_paired": "This device is not paired with that one.",
    "error.not_supported": "Not supported on this platform.",
    "error.lan_not_running": "Local network sync is not running.",
    "error.lan_not_ready": "Local network sync is still starting up.",
    "error.lan_operation_failed": "The local network operation failed.",
    "error.internet_sync_off": "Internet sync is off. Turn it on to pair over the internet.",
    "error.invalid_pairing_code": "That pairing code is not valid.",
    "error.invalid_password": "Wrong password.",
    "error.invalid_name": "That name is not allowed.",
    "error.save_failed": "Could not save.",
    "error.copy_failed": "Could not copy.",
    "error.send_failed": "Could not send.",
    "error.open_failed": "Could not open it.",
    "error.reveal_failed": "Could not open that folder.",
    "error.export_failed": "Could not export.",
    "error.import_failed": "Could not import.",
    "error.storage_error": "The data could not be read or written.",
    "error.data_in_use": "That data is in use by something else.",
    ...
    "error.data_invalid": "That data is damaged and has to be repaired before it can be used.",
    "error.invalid_url": "That is not a web link ClipSync can open.",
    "error.lan_start_failed": "Local network sync could not start.",
    "error.relay_offline": "The relay is not connected yet. Try again in a moment.",
    "error.internet_pairing_unavailable": "Internet pairing is not set up on this device.",
    "error.clipboard_write_failed": "Could not write to the clipboard.",
    "error.aiconfig_unavailable": "AI configuration is not available on this device.",
    "error.translate_failed": "The translation did not go through.",
    "error.companion_start_failed": "The phone companion could not start.",
    "error.companion_stop_failed": "The phone companion could not stop.",
    "error.companion_stopping": "The phone companion is still stopping. Try again in a moment.",
    "error.reset_failed": "ClipSync could not stop its services, so nothing was reset.",
    "error.restore_partial_failed": "The restore was incomplete; some data may have changed.",
    "error.internal_error": "Something went wrong inside ClipSync. Nothing was changed.",
    # The sentences a code cannot tell apart (MESSAGE_KEYS in
    # internal/application/errors.py).  Each one is a refusal a reader can
    # bring about themselves, which is why it is spelled out rather than
    # folded into its code's sentence above.
    "error.invalid_group_name": "That group name cannot be used.",
    "error.favorite_empty": "A favorite needs a title or some content.",
    "error.text_required": "There is no text to send.",
    "error.text_too_long": "That text is too long to send.",
    "error.url_scheme": "Only http and https links can be sent.",
    "error.no_files_to_send": "There is nothing to send.",
    "error.folder_empty": "That folder has no files in it.",
    "error.no_entry_to_download": "That record has nothing to download.",
    "error.only_received_files": "Only a file this device received can be opened.",
    "error.transfer_no_file": "That transfer saved no file.",
    "error.transfer_not_retryable": "That transfer cannot be retried.",
    "error.unsupported_export_format": "That export format is not supported.",
    "error.no_relay_brokers": "No relay server is configured.",
    "error.device_gone": "That device is no longer in the list.",
    "error.history_item_gone": "That record is no longer in the history.",
    "error.favorite_gone": "That favorite is no longer there.",
    "error.internet_peer_gone": "That device is no longer in the internet pairing list.",
    "error.transfer_gone": "That transfer is no longer there.",
    "error.file_gone": "That file is no longer on this machine.",
    "error.received_file_gone": "That received file is no longer on this machine.",
    "error.removed_device_gone": "That device is not in the removed list.",
    "error.no_certificate_change": "There is no certificate change waiting to be confirmed.",
    "error.file_on_other_device": "It is on the device that published it — download it first.",
    "error.device_must_reconnect": "That device has to connect again to be trusted.",
    # Why an OS repair from the diagnostics card did not happen.  The sidecar
    # words these because both fronts show the answer verbatim (see
    # internal/diagnostics/actions.py).
    "diagnostics.action.firewall_pane_failed": "Could not open the macOS firewall settings.",
    # The Windows repair tries the rule unelevated, then through a UAC prompt,
    # then the settings page -- so the sentence has to cover all three.
    "diagnostics.action.firewall_rule_failed": "Could not create the firewall rule (admin rights may be required) or open the firewall settings.",  # noqa: E501
    "diagnostics.action.firewall_manual": "Allow the ports manually as root: {script}",
    "diagnostics.action.firewall_unsupported": "Firewall settings are not supported on this OS.",
    "diagnostics.action.local_network_pane_failed": "Could not open the macOS Local Network permission settings.",  # noqa: E501
    "diagnostics.action.windows_settings_failed": "Could not open the Windows network/firewall settings.",  # noqa: E501
    "diagnostics.action.permission_unsupported": "Permission settings are not supported here.",
    "diagnostics.action.unknown": "Unknown action: {action}",
    ...
    "device.test_channel_lan": "LAN",
    "device.test_channel_relay": "Relay",
    "device.test_channel_ok": "{channel} {latency}ms",
    "device.test_channel_fail": "{channel}: {reason}",
    "device.test_no_channel": "No reachable channel (not paired / internet sync off)",
    "device.test_timeout": "no reply in time",
    "device.test_send_failed": "could not send",
    "device.test_relay_offline": "relay not online",
    # Device info labels
    "device_info.name": "Name:",
    "device_info.id": "Device ID",
    "device_info.platform": "Platform",
    "device_info.service": "Service",
    # Device status: chat-only (unpaired) live sessions are temporary
    "device.temporary_connected": "Temporary connection",
    "device.restore": "Restore",
    "device.purge": "Delete permanently",
    # Settings
    ...
    "footer.name_updated": "Device name updated",
    ...
    "tray.pause_for": "Pause Sync",
    "tray.pause_15m": "15 minutes",
    "tray.pause_30m": "30 minutes",
    "tray.pause_1h": "1 hour",
    "tray.paused_left": "Paused · ~{minutes} min left",
    "tray.resume_now": "Resume Sync Now",
    ...
    "settings_window.relay_pw_change_btn": "Change password",
    "settings_window.relay_pw_new": "New password",
    "settings_window.relay_pw_repeat": "Enter the new password again",
    ...
    "settings_window.password_rules": "A new password must contain all of the following:",
    "settings_window.password_rule_length": "At least 12 characters (and no more than 200)",
    "settings_window.password_rule_upper": "An uppercase letter (A–Z)",
    "settings_window.password_rule_lower": "A lowercase letter (a–z)",
    "settings_window.password_rule_digit": "A number (0–9)",
    "settings_window.password_rule_special": "A special character (e.g. ! @ # _)",
    "settings_window.password_invalid": "Password does not meet the requirements.",
    ...
    "settings_window.history_max_desc": "Maximum clipboard history entries to keep (10–10000)",
    ...
    "settings_window.val_history_entries": "History entries must be 10–10000",
    ...
    "chat.attach_internet": "Attach a file (internet relay, max 5 MB)",
    "chat.cancel": "Cancel",
...
_ZH: dict[str, str] = {
    "error.app_locked": "应用已锁定，解锁后再试。",
    "error.not_found": "未找到。",
    "error.not_connected": "设备未连接。",
    "error.not_paired": "本机与该设备未配对。",
    "error.not_supported": "当前平台不支持此功能。",
    "error.lan_not_running": "局域网同步未运行。",
    "error.lan_not_ready": "局域网同步仍在启动中。",
    "error.lan_operation_failed": "局域网操作失败。",
    "error.internet_sync_off": "互联网同步已关闭，打开后才能通过互联网配对。",
    "error.invalid_pairing_code": "配对码无效。",
    "error.invalid_password": "密码错误。",
    "error.invalid_name": "该名称不可用。",
    "error.save_failed": "保存失败。",
    "error.copy_failed": "复制失败。",
    "error.send_failed": "发送失败。",
    "error.open_failed": "无法打开。",
    "error.reveal_failed": "无法打开该文件夹。",
    "error.export_failed": "导出失败。",
    "error.import_failed": "导入失败。",
    "error.storage_error": "数据读取或写入失败。",
    "error.data_in_use": "该数据正被其他操作占用。",
    ...
    "error.data_invalid": "数据已损坏，需要先修复才能使用。",
    "error.invalid_url": "这不是 ClipSync 能打开的网页链接。",
    "error.lan_start_failed": "局域网同步未能启动。",
    "error.relay_offline": "本机还未连上中继，请稍后再试。",
    "error.internet_pairing_unavailable": "本机尚未配置互联网配对。",
    "error.clipboard_write_failed": "写入剪贴板失败。",
    "error.aiconfig_unavailable": "本机无法使用 AI 配置功能。",
    "error.translate_failed": "翻译没有完成。",
    "error.companion_start_failed": "手机伴侣未能启动。",
    "error.companion_stop_failed": "手机伴侣未能停止。",
    "error.companion_stopping": "手机伴侣仍在关闭中，请稍后再试。",
    "error.reset_failed": "ClipSync 未能停止后台服务，因此没有重置。",
    "error.restore_partial_failed": "恢复未完成，部分数据可能已经变化。",
    "error.internal_error": "ClipSync 内部出错，本次操作没有生效。",
    "error.invalid_group_name": "该分组名称不可用。",
    "error.favorite_empty": "收藏至少要有标题或内容。",
    "error.text_required": "没有可发送的文本。",
    "error.text_too_long": "文本太长，无法发送。",
    "error.url_scheme": "只能发送 http 或 https 链接。",
    "error.no_files_to_send": "没有可发送的文件。",
    "error.folder_empty": "该文件夹里没有文件。",
    "error.no_entry_to_download": "这条记录没有可下载的内容。",
    "error.only_received_files": "只能打开本机接收到的文件。",
    "error.transfer_no_file": "这次传输没有保存文件。",
    "error.transfer_not_retryable": "这次传输无法重试。",
    "error.unsupported_export_format": "不支持这种导出格式。",
    "error.no_relay_brokers": "没有配置中继服务器。",
    "error.device_gone": "该设备已不在列表中。",
    "error.history_item_gone": "这条历史记录已不存在。",
    "error.favorite_gone": "这条收藏已不存在。",
    "error.internet_peer_gone": "该设备已不在互联网配对列表中。",
    "error.transfer_gone": "这次传输记录已不存在。",
    "error.file_gone": "该文件已不在本机。",
    "error.received_file_gone": "这个接收到的文件已不在本机。",
    "error.removed_device_gone": "该设备不在已移除列表中。",
    "error.no_certificate_change": "没有等待确认的证书变更。",
    "error.file_on_other_device": "该文件还在发布它的那台设备上，请先下载到本机。",
    "error.device_must_reconnect": "需要该设备重新连接一次，才能信任它。",
    "diagnostics.action.firewall_pane_failed": "无法打开 macOS 防火墙设置。",
    "diagnostics.action.firewall_rule_failed": "未能添加防火墙规则，也没能打开防火墙设置。",
    "diagnostics.action.firewall_manual": "请以 root 身份手动放行端口：{script}",
    "diagnostics.action.firewall_unsupported": "本系统不支持防火墙设置。",
    "diagnostics.action.local_network_pane_failed": "无法打开 macOS 的本地网络权限设置。",
    "diagnostics.action.windows_settings_failed": "无法打开 Windows 的网络/防火墙设置。",
    "diagnostics.action.permission_unsupported": "本系统不支持权限设置。",
    "diagnostics.action.unknown": "未知操作：{action}",
    ...
    "device.test_channel_lan": "局域网",
    "device.test_channel_relay": "中继",
    "device.test_channel_ok": "{channel} {latency}ms",
    "device.test_channel_fail": "{channel}：{reason}",
    "device.test_no_channel": "无可用通道（未配对或未开互联网同步）",
    "device.test_timeout": "未在时限内回复",
    "device.test_send_failed": "发送失败",
    "device.test_relay_offline": "中继未在线",
    "device_info.name": "名称：",
    "device_info.id": "设备 ID",
    "device_info.platform": "平台",
    "device_info.service": "服务",
    "device.temporary_connected": "临时连接",
    "device.restore": "恢复",
    "device.purge": "彻底删除",
    ...
    "transfer.speed_test.lan_only": "测速仅支持局域网——请让两台设备处于同一 Wi-Fi 或局域网",
    ...
    "tray.pause_for": "暂停同步",
    "tray.pause_15m": "15 分钟",
    "tray.pause_30m": "30 分钟",
    "tray.pause_1h": "1 小时",
    "tray.paused_left": "已暂停 · 剩余约 {minutes} 分钟",
    "tray.resume_now": "立即恢复同步",
    "tray.device": "设备：{name}",
    ...
    "settings_window.search_placeholder": "搜索设置…",
    "settings_window.search_matches": "{count} 个分组匹配“{query}”",
    "settings_window.search_no_matches": "没有匹配“{query}”的设置项",
    ...
    "settings_window.relay_pw_change_btn": "修改密码",
    "settings_window.relay_pw_new": "新密码",
    "settings_window.relay_pw_repeat": "再次输入新密码",
    "settings_window.relay_pw_confirm": "确认设置",
    "settings_window.relay_pw_cancel": "取消",
    "settings_window.relay_pw_required": "请在两个输入框中都输入密码。",
    "settings_window.relay_pw_mismatch": "两次输入的密码不一致——只有两次一致时才会保存。",
    "settings.relay_password_saved": "中继密码已设置",
    "settings.relay_password_cleared": "中继密码已清除",
    ...
    "settings_window.password_rules": "新密码必须同时满足以下要求：",
    "settings_window.password_rule_length": "至少 12 个字符（不超过 200）",
    "settings_window.password_rule_upper": "包含大写字母（A–Z）",
    "settings_window.password_rule_lower": "包含小写字母（a–z）",
    "settings_window.password_rule_digit": "包含数字（0–9）",
    "settings_window.password_rule_special": "包含特殊字符（如 ! @ # _）",
    "settings_window.password_invalid": "密码不符合要求。",
    ...
    "settings_window.history_max_desc": "保留的剪贴板历史最大条数（10–10000）",
    ...
    "settings_window.val_history_entries": "历史条数必须在 10–10000 范围内",
    ...
    "chat.send": "发送",
    "chat.attach": "发送文件",
    "chat.attach_internet": "发送文件（互联网中继，上限 5 MB）",
    "chat.cancel": "取消",
    ...
    "chat.err_internet_file_cap": "互联网模式发送文件上限为 5 MB。",
